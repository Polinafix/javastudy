 ...
 */
public class HashMap_IntegerString {
    public static void main(String[] args) {
        ...
        Set<Integer> keys = fruit.keySet(); // Set - хранит только уникальные значения, при попытке добавить дубль - игнор дубля
        ...
        String value = fruit.get(10);
        System.out.println();
        System.out.println(value);

        // проверка на наличие в карте ключа/значения
        System.out.println(fruit.containsKey(10)); // true
        ...
        System.out.println("to remove: " + fruit.remove(9));
        System.out.println(fruit);
